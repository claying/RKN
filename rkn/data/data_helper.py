...
class TensorDataset(Dataset):
    def __init__(self, data_tensor, target_tensor, length_tensor,
                 noise=0.0, max_index=4, return_len=True):
    ...
    def __getitem__(self, index):
        ...
        return data_tensor, self.target_tensor[index], self.length_tensor[index], noise_mask
    ...
    def augment(self, noise=0.1, quantity=10):
        ...
        self.length_tensor = self.length_tensor.repeat(quantity)
